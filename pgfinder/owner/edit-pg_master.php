                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <?php echo "<td><img src='../admin/pgdocs/{$selectrow['pg_registrationdocs']}' style='width:200px;height:200px'</td>"; ?>
                          </div>
                        </div>
                      </div>
                        <div class="col-md-12">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                           <?php echo "<td><img src='../admin/pgdocs/{$selectrow['pg_idproof']}' style='width:200px;height:200px'</td>"; ?>
                          </div>
                        </div>
                      </div>
