            ...
            <div class="row" align="center">
              ...
              <div class="col-md-4 col-sm-4 login-form">
                ...
                <div class="input-group">
                  <button type="submit" class="btn btn-primary" onClick="window.location.href='admin/login.php'">
                    Start With The Admin Panel
                  </button>
                </div>
                <br>
                <div class="input-group">
                  <button type="submit" class="btn btn-primary" onClick="window.location.href='user/login.php'">
                    Start With The User Panel
                  </button>
                </div>
                <br>
                <div class="input-group">
                  <button type="submit" class="btn btn-primary" onClick="window.location.href='owner/login.php'">
                    Start With The PgOwner Panel
                  </button>
                </div>
