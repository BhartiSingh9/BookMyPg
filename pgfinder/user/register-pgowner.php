          ...
          <div class="page">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 register-form">
                  ...
                  Gender: <input type="radio" id="gender" name="gender" value="male">
                  <label>Male</label>
