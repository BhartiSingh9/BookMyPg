        ...
        <div class="row">
          <div class="col-md-8">
            <div class="single-property">
              ...
              <div class="property-amenities clearfix"> <span class="area"><strong>AC</strong></span> <span class="area"><strong>WIFI</strong>Area</span> <span class="baths"><strong>3</strong>Sharing</span>  <span class="parking"><strong>Laundry</strong></span> </div>
                  ...
                  <div id="amenities">
                    <div class="additional-amenities">
                        <?php 
                                    ...
                                    echo "<b> {$pgdata['pg_amenities']} </b> \n";
                                  echo "<br>";
                                    echo "\n <b>No of Sharing:{$pgdata['pg_sharing']}"
